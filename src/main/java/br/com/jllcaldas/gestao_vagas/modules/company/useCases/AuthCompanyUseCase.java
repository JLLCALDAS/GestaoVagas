...
import br.com.jllcaldas.gestao_vagas.modules.company.dto.AuthCompanyDTO;
import br.com.jllcaldas.gestao_vagas.modules.company.dto.AuthCompanyResponseDTO;
...
public class AuthCompanyUseCase {
    ...
    public AuthCompanyResponseDTO execute(AuthCompanyDTO authCompanyDTO) {
        ...
        var token = JWT.create()
            ...
            .withExpiresAt(expiresIn) // 2 hours
